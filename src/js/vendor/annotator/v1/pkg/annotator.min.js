...
!function () {
    ...
    Annotator = function (_super) {
        ...
        Annotator.prototype.setupAnnotation = function (annotation) {
            ...
            //DD
            console.log('setup Annotation',annotation);

            //DD uncomment this for bypassing tooltip create note
            //this.publish("beforeAnnotationCreated", [annotation]);
            return annotation
        };
        ...
        Annotator.prototype.loadAnnotations = function (annotations) {
            ...
            loader = function (annList) {
                ...
                if (annList.length > 0) {
                    ...
                    console.log('annotationsLoaded',clone);
        ...
        Annotator.prototype.startViewerHideTimer = function () {
            //DD stop hiding when mousing out of an annotation
            console.log('startViewerHideTimer');
        ...
        Annotator.prototype.checkForEndSelection = function (event) {
            ...
            if (event && this.selectedRanges.length) {
                ...
                // DD uncomment setupAnnotation for bypassing tooltip create note
                // and comment this.adder.css
        ...
        Annotator.prototype.onAdderClick = function (event) {
            ...
            this.adder.hide();
            //DD
            console.log('this.setupAnnotation');
        ...
        Annotator.prototype.onEditAnnotation = function (annotation) {
            ...
            //DD stop hidel all when editing
            this.viewer.hide();
