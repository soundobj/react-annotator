    ...
    Annotator.Plugin.Widget = Widget = (function(superClass) {
        ...
        Widget.prototype.pluginInit = function() {
            ...
            this.annotator.onHighlightMouseover = function(event) {
                ...
                //TODO: use scrollintoview complete: notify to pass a callback so we can
                // ensure the RHS annotation is displayed correctly. there are edge cases
                // that is only partially displayed.
                $(Widget.mousedOveredAnnotation).scrollintoview({duration:1500});
            ...
            this.annotator.startViewerHideTimer = function() {
                ...
                if(Widget.mousedOveredAnnotation) {
